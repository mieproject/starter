    ...
    <div class="row gap-20 masonry pos-r">
        ...
        <div class="masonry-item  w-100">
            <div class="row gap-20">
                @foreach(config('variables.statistics') as $box)
                <!-- #{{$box['label']}} ==================== -->
                <div class='{{ ((isset($box['class']) and !empty($box['class']))?$box['class']:'col-md-3') }}'>
                    <div class="layers bd bgc-white p-20">
                        <div class="layer w-100 mB-10">
                            <h6 class="lh-1">{{$box['label']}}</h6>
                        </div>
...
{{--                                    <span id="sparklinedash"></span>--}}
                                ...
                                <div class="peer">
                                    <span class="d-ib lh-0 va-m fw-600 bdrs-10em pX-15 pY-15 bgc-green-50 c-green-500">
                                        {{ (isset($box['where'])? (new $box['model'])->where($box['where'])->{$box['callback']}() : (new $box['model'])->{$box['callback']}()) }}
                                    </span>
                                </div>
                            </div>
                        </div>
